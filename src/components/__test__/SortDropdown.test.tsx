...
describe('SortDropdown', () => {
  ...
  test('renders the SortDropdown with the correct items', () => {
    render(<SortDropdown handleSort={mockHandleSort} />);
  ...
  test('calls handleSort with the correct argument when an item is clicked', () => {
    render(<SortDropdown handleSort={mockHandleSort} />);
