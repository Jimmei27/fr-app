...
export var useSearchDogs = function (filters) {
    ...
    var _a = useQuery({
        ...
        queryFn: function () { return searchDogs(filters); }
    }), dogId = _a.data, isLoadingDogIg = _a.isLoading, refetch = _a.refetch;
    // get dogs
    var _b = useQuery({
        queryKey: ['dogs', (dogId === null || dogId === void 0 ? void 0 : dogId.resultIds) || []],
        queryFn: function () { return getDogs((dogId === null || dogId === void 0 ? void 0 : dogId.resultIds) || []); },
        enabled: !!(dogId === null || dogId === void 0 ? void 0 : dogId.resultIds)
    }), dogDatas = _b.data, isLoadingDogs = _b.isLoading;
    return {
        dogDatas: dogDatas,
