...
var SearchView = function () {
  ...
  useEffect(
    function () {
      setFilter(function (prevFilter) {
        return __assign(__assign({}, prevFilter), {
  ...
  var onSelectDogBreed = function (id, breed) {
    setFavoriteBreeds(function (prevBreeds) {
      var isSelected = prevBreeds.some(function (breed) {
        return breed.id === id;
      });
      if (isSelected) {
        return prevBreeds.filter(function (breed) {
          return breed.id !== id;
        });
      } else {
        return __spreadArray(
          __spreadArray([], prevBreeds, true),
          [{ id: id, breed: breed }],
          false
        );
      }
  ...
  var onMatchDogClick = function () {
    matchDog(
      favoriteBreeds.map(function (breed) {
        return breed.id;
      })
    );
  };
  ...
  return _jsxs('div', {
    className: 'vh-100 d-flex flex-rows',
    children: [
      _jsxs(Col, {
        md: 3,
        className: 'bg-light p-4',
        children: [
          _jsx('h4', { children: 'Search Fields' }),
          _jsx(SearchForm, { breeds: breeds, setFilter: handleSubmit }),
          _jsx(FavoriteDogs, {
            selectedBreeds: favoriteBreeds,
            onMatchClick: onMatchDogClick,
            onResetClick: function () {
              return setFavoriteBreeds([]);
            },
          }),
        ],
      }),
      _jsxs(Col, {
        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              _jsx(SortDropdown, { handleSort: handleSort }),
              _jsx(Button, {
                onClick: function () {
                  return logout();
                },
          ...
          dogData.length > 0
            ? _jsxs(_Fragment, {
                children: [
                  _jsx(Row, {
                    className: 'g-3 mx-3 row-cols-5',
                    children:
                      dogData === null || dogData === void 0
                        ? void 0
                        : dogData.map(function (dog) {
                            return _jsx(
                              SearchDogCard,
                              { dog: dog, onSelectDogBreed: onSelectDogBreed },
                              dog.id
                            );
                          }),
                  }),
            ...
            : _jsx('div', {
                ...
                children: _jsx('h5', {
                  children: 'Please change the search fields and search again.',
                }),
              }),
        ],
      }),
      matchDogSuccess && matchData != null
        ? _jsx(MatchedModal, { dogId: matchData })
        : null,
    ],
  });
};
